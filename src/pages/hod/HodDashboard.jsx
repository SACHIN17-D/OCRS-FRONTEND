...
import { getHodReports, confirmHodMeeting } from '../../services/api';
...
export default function HodDashboard() {
  ...
  const handleConfirm = async (e) => {
    ...
    try {
      await confirmHodMeeting(selected._id, { meetingNotes });
      ...
      <div style={{ padding: '28px 32px', maxWidth: 1000, margin: '0 auto' }} className="page-enter">
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 13, marginTop: 4 }}>
            Department: <strong style={{ color: '#00d2ff' }}>{user?.department}</strong> — Students requiring meeting
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginBottom: 28 }}>
          {[
            ...
            { label: 'Total Students', value: data.students.length, color: '#00d2ff' },
          ].map(stat => (
        ...
        {loading ? (
          ...
          <div className="card" style={{ textAlign: 'center', padding: 56 }}>
            ...
            <p style={{ color: 'var(--muted)', fontSize: 13 }}>All students in your department are in good standing!</p>
          </div>
        ) : (
            ...
            {data.reports.map(report => {
              ...
              return (
                <div key={report._id} className="card" style={{
                  borderLeft: `4px solid ${report.meetingStatus === 'confirmed' ? '#22c55e' : '#ef4444'}`,
                }}>
                    ...
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                        ...
                        <span style={{
                          ...
                          background: report.meetingStatus === 'confirmed' ? 'var(--green-light)' : 'var(--red-light)',
                      ...
                      <div style={{ fontSize: 13, color: 'var(--text2)', marginTop: 4 }}>
                        ⚠️ Warning Count: <strong style={{ color: '#ef4444' }}>{student?.warningCount || 3}</strong>
                      </div>
                    </div>
        ...
        {selected && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ padding: '12px 16px', background: 'rgba(0,210,255,0.05)', border: '1px solid rgba(0,210,255,0.2)', borderRadius: 8, marginBottom: 20, fontSize: 13, color: 'var(--text2)' }}>
